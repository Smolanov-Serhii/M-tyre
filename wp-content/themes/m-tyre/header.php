...
<div id="main-page" class="main-page">
	<header id="header" class="header">
        <div class="fade-mob-menu"></div>
        <div class="header-mobile">
            <div class="header-mobile__header">
                <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.307617" y="16.2637" width="23" height="3" transform="rotate(-45 0.307617 16.2637)" fill="white"/>
                    <rect x="2.42896" width="23" height="3" transform="rotate(45 2.42896 0)" fill="white"/>
                </svg>
                <div class="header-mobile__header-title"><?php echo the_field('nadpis_menyu', 'options');?></div>
            </div>
            ...
            <div class="footer__nav">
                ...
                <div class="to-wishlist">
                    <a href="<?php echo get_home_url() . '/wishlist/view' ?>">
                        <?php echo the_field('nadpis_izbrannoe', 'options');?>
                    </a>
                </div>
            </div>
